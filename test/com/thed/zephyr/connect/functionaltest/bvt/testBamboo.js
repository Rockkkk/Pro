...
describe('ZFJ Cloud Testing For Jira Admin', function() {
     ...
     */
    xit('Addons is Uploaded Successfully.', function () {
        logout = false;
        logger.info("bvt-1 started.");
     ...
     */
    it('Clone a Test step by entered a valid step number.', function (done) {
        logout = false;
        /*var createTestMap = {
         TESTNAME : "IE-12",
         SUMMARY: "Version 2.0"
     ...
     */
    it('Test is Cloned Successfully.', function (done) {
        logout = false;
        /*var createTestMap = {
         SUMMARY: "Version 1.0",
         PRIORITY: "Minor",
     ...
     */
    it('Search test by Summary', function (done) {
        logout = false;
        /*var createTestMap = {
         TESTNAME : "IE-12",
         SUMMARY: "Version 2.0"
     ...
     */
    it('Test is executed to NEW Status Successfully.', function (done) {
        logout = false;
        var executeTestMap = {
            VERSIONNAME: "Version 1.0",
            CYCLENAME: "cycle one",
     ...
     */
    it('Execute all test steps to a single status and set overall test execution status to suggested value.', function (done) {
        logout = false;
        var executeTestMap = {
            VERSIONNAME: "Version 1.0",
            CYCLENAME: "cycle one",
    ...
    it('Test is executed With New Defect.', function(done) {
        logout = false;
        var executeTestMap = {
            VERSIONNAME : "Version 1.0",
            CYCLENAME : "cycle one",
    ...
    it('STEP is executed With New Defect.', function(done) {
        logout = false;
        var executeTestMap = {
            VERSIONNAME : "Version 1.0",
            CYCLENAME : "cycle one",
    ...
    it("Should be able to add tests to Test Cycle Via Saved JIRA search Successfully.", function (done) {
        logout = false;
        var executeTestMap = {
            VERSIONNAME : "Version 1.0",
            CYCLENAME : "cycle four",
     ...
     */
    it('Dock/Undock the predefined Filter', function (done) {
        logout = false;
